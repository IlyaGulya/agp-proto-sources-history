...
private static final long serialVersionUID = 0L;
  ...
  public static final int CPU_BRANDNAME_FIELD_NUMBER = 11;
  @SuppressWarnings("serial")
  private volatile java.lang.Object cpuBrandname_ = "";
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public boolean hasCpuBrandname() {
   ...
   */
  @java.lang.Override
  public java.lang.String getCpuBrandname() {
    java.lang.Object ref = cpuBrandname_;
    if (ref instanceof java.lang.String) {
      return (java.lang.String) ref;
    } else {
      com.google.protobuf.ByteString bs = 
  ...
  public static final int CPU_ARCHITECTURE_FIELD_NUMBER = 12;
  @SuppressWarnings("serial")
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (((bitField0_ & 0x00000400) != 0)) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 11, cpuBrandname_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000400) != 0)) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(11, cpuBrandname_);
    }
    if (((bitField0_ & 0x00000800) != 0)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasCpuBrandname() != other.hasCpuBrandname()) return false;
    if (hasCpuBrandname()) {
      if (!getCpuBrandname()
          .equals(other.getCpuBrandname())) return false;
    }
    if (hasCpuArchitecture() != other.hasCpuArchitecture()) return false;
  ...
  public int hashCode() {
    ...
    if (hasCpuBrandname()) {
      hash = (37 * hash) + CPU_BRANDNAME_FIELD_NUMBER;
      hash = (53 * hash) + getCpuBrandname().hashCode();
    }
    if (hasCpuArchitecture()) {
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.wireless.android.sdk.stats.EmulatorHost result) {
      ...
      if (((from_bitField0_ & 0x00000400) != 0)) {
        result.cpuBrandname_ = cpuBrandname_;
    ...
    public Builder mergeFrom(com.google.wireless.android.sdk.stats.EmulatorHost other) {
      ...
      if (other.hasCpuBrandname()) {
        cpuBrandname_ = other.cpuBrandname_;
        bitField0_ |= 0x00000400;
        onChanged();
      }
      if (other.hasCpuArchitecture()) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90: {
              cpuBrandname_ = input.readBytes();
              bitField0_ |= 0x00000400;
              break;
            } // case 90
            case 98: {
              cpuArchitecture_ = input.readBytes();
              bitField0_ |= 0x00000800;
              break;
            } // case 98
            case 104: {
    ...
    private java.lang.Object cpuBrandname_ = "";
    /**
     * <pre>
     * CPU brand name, such as "Intel Core i9 14900K" and "Apple M1 Pro"
     * </pre>
     ...
     *
     * <code>optional string cpu_brandname = 11;</code>
     * @param value The cpuBrandname to set.
     * @return This builder for chaining.
     */
    public Builder setCpuBrandname(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      cpuBrandname_ = value;
      bitField0_ |= 0x00000400;
     ...
     * @return This builder for chaining.
     */
    public Builder clearCpuBrandname() {
      cpuBrandname_ = getDefaultInstance().getCpuBrandname();
     ...
     *
     * <code>optional string cpu_brandname = 11;</code>
     * @param value The bytes for cpuBrandname to set.
     * @return This builder for chaining.
     */
    public Builder setCpuBrandnameBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      cpuBrandname_ = value;
      bitField0_ |= 0x00000400;
